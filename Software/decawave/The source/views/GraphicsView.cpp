...
void GraphicsView::scaleView(qreal sx, qreal sy, QPointF center)
{
    ...
    visibleRect.setWidth(qBound(0.1, visibleRect.width() * sx, 100.));
    visibleRect.setHeight(qBound(0.1, visibleRect.height() * sy, 100.));
...
{
    qreal s = 1.206; //zoom out (zoom in use 0.74)
