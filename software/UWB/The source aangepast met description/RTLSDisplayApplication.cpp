...
RTLSDisplayApplication::RTLSDisplayApplication(int &argc, char **argv) : QApplication(argc, argv)
{
    ...
    this->setOrganizationName("Fontys");
    this->setOrganizationDomain("Fontys.nl/EGT");
    this->setApplicationName("POC UWB v1.0");
    ...
    QObject::connect(_client, SIGNAL(anchPos(quint64,double,double,double,bool)), graphicsWidget(), SLOT(anchPos(quint64,double,double,double,bool)));
