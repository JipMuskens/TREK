/*! ----------------------------------------------------------------------------
 *  @file    deca_regs.h
 *  @brief   Decawave DW1000 Register Definitions
...
/*offset 24 */
#define TX_FCTRL_TXBOFFS_MASK	0xFF000000UL	/* bit mask to access Transmit buffer index offset 10-bit field */
/*offset 32 */
...
#define CLEAR_ALLRXGOOD_EVENTS  (SYS_STATUS_RXDFR | SYS_STATUS_RXFCG | SYS_STATUS_RXPRD | \
                                SYS_STATUS_RXSFDD | SYS_STATUS_RXPHD | SYS_STATUS_LDEDONE) /* Clear all RX event flags after a packet reception */
#define CLEAR_DBLBUFF_EVENTS    (SYS_STATUS_RXDFR | SYS_STATUS_RXFCG) //| SYS_STATUS_LDEDONE)

#define CLEAR_ALLRXERROR_EVENTS (SYS_STATUS_RXPHE | SYS_STATUS_RXFCE | SYS_STATUS_RXRFSL | \
			 	 	 	 		SYS_STATUS_RXSFDTO | SYS_STATUS_RXRFTO | SYS_STATUS_RXPTO |\
                                SYS_STATUS_AFFREJ | SYS_STATUS_LDEERR) /* Clear all RX event flags after an rx error */

#define CLEAR_ALLTX_EVENTS	    (SYS_STATUS_AAT | SYS_STATUS_TXFRB | SYS_STATUS_TXPRS | \
								SYS_STATUS_TXPHS | SYS_STATUS_TXFRS	) /* Clear all TX event flags */
...
#define GPIO_LNA_byte_no		(2)				/* byte offset for LNA drive */
#define GPIO_PIN5_EXTTXE_8		0x01			/* The pin operates as the EXTTXE output. byte */
#define GPIO_PIN6_EXTRXE_8		0x04			/* The pin operates as the EXTRXE output. byte */
...
//#define RF_RXCTRLH_			0x00000000UL	/*  */
